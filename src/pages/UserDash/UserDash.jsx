      ...
      <div className="min-h-screen bg-zinc-50 rounded-xl p-4 md:p-8 mt-8">
        <div className=" mx-auto">
          <header className="mb-8 flex justify-between items-center">
            <h1 className="text-3xl font-bold text-brand-black">Update your account
            </h1>
          </header>
          ...
          <div className="flex flex-col md:flex-row gap-8">
            <nav className="w-full md:w-64 space-y-4">
              ...
              >
                Account Details <span><User2Icon/></span>
              </Button>
              <Button
                  className={`w-full`}
              ...
              >
                Previous Orders <span><PackageIcon strokeWidth={1.4}/></span>
              </Button>
              ...
              <Button
                  ...
                  variant="outline"
              >
                Logout <span>{isPending? <Spinner className={`size-5`}/> : <LogOutIcon size={16}/>}</span>
              </Button>
            </nav>
