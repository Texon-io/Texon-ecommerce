  ...
  return (
    <div className={`space-y-4`}>
      <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100">
        <h2 className="text-xl font-bold mb-6 text-brand-black">
        ...
        <div className="space-y-5">
          ...
          <div className={`w-full text-right space-x-4`}>
            <Button variant={`outline`} onClick={() => setName("Abdulrahman")}>
              Cancel
            </Button>
            <Button onClick={handleUpdateFullname}>Save Changes</Button>
          </div>
        </div>
      </div>
      <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100">
